    ...
    <div className="w-full overflow-hidden ">
      ...
      <div className="grid lg:grid-cols-3 md:grid-cols-2 max-sm:grid-cols-1  gap-20 justify-items-center p-[5vw]">
        {solutionsdata.map((solution, index) => (
          <Link to={`/solutions/${solution.link}`} key={index} className="relative h-[400px] rounded-md lg:w-[28vw] md:w-[40vw] w-full flex justify-center items-end">
            <img className="w-full h-full object-cover absolute rounded-md" src={solution.poster} alt="" />
      ...
      <div className="w-full mt-[100px] bg-[#F4F9FE] flex max-md:flex-col items-center justify-center gap-20 px-[5vw] relative ">
        ...
        <div className="w-1/2 max-md:w-full h-full relative">
          <img className="w-full h-[400px] object-cover" src={experties1} alt="" />
        </div>
      ...
      <div className="w-full mt-[100px] bg-[#F4F9FE] flex max-md:flex-col items-center justify-center gap-20 px-[5vw]  relative">
        ...
        <div className="w-1/2 max-md:w-full h-full relative">
          ...
          <img className="w-full h-[400px] object-cover" src={experties2} alt="" />
        </div>
      </div>

      <div className="py-[20px] px-[4vw] my-[20px]"  >
