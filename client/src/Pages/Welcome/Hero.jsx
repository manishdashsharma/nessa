    ...
    <div className="relative">
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          <button className="group px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 rounded-full font-semibold flex items-center justify-center gap-2 transform hover:scale-105 transition-all shadow-lg hover:shadow-blue-500/25">
            Get Started 
            <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
          </button>
          {/* <button className="px-8 py-4 bg-white/5 hover:bg-white/10 backdrop-blur-sm rounded-full font-semibold transform hover:scale-105 transition-all border border-white/10">
            View Demo
          </button> */}
        </div>
      </motion.div>
