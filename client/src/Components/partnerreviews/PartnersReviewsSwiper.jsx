    ...
    <div className="py-[50px]">
      ...
      {loading ? (
        <div className="flex justify-center items-center h-64">
          <div className="loader"></div> {/* Replace with your CircularProgress component or loader */}
        </div>
                ...
                <div className="bg-white min-h-[400px] rounded-3xl shadow-lg p-8 max-w-md">
                  <div className="flex flex-col items-center text-center space-y-4">
                    ...
                    <div className="relative">
                      <span className="text-4xl text-blue-500 absolute -left-4 -top-4">
                        "
                      </span>
                      <p className="text-gray-700 italic pt-4 px-4 leading-relaxed">
                        {testimonial.description}
                      </p>
                      <span className="text-4xl text-blue-500 absolute -right-4 bottom-0">
                        "
                      </span>
                    </div>
                  </div>
